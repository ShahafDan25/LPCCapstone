...
<html>
    ...
    <body class = "signups-page-body">
        <header class = "nav-bar" style = "margin-right: 5% !important;">
            <h2 class = "index-registration-page-header-title inline"> Las Positas College: The Market </h2>
            <h5 class = "index-registration-page-header-sub-title inline"><u> <!-- <?php echo volunteer_name_from_email($_SESSION['volunteer-id']);?> --> </u></h5>
            <a href = "volunteer-profile.php" class = "nav-bar-option responsive inline" style = "float: right !important;"><i class="fa fa-user" aria-hidden="true"></i> Profile </a>
        ...
        <div class = "page-container">
            ...
            <br>
            <div class = "page-sub-container" id = "signup-sheet-container">
    ...
    <script>
        $(document).on('change', '#marketid', function() {
            ...
            $.ajax ({
                type: "POST",
                url: "funcs.php",
                data: {date: document.getElementById("marketid").value, message: "display-signup-sheet"},
